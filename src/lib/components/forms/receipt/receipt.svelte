<svelte:head>
  <title>{$bi('receipt_title')}</title>
  <meta http-equiv="Content-Language" content="ja" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <link rel="stylesheet" href="/bootstrap-icons/font/bootstrap-icons.css">
  <link rel="stylesheet" href="/stylesheets/paperA4.css">
  ...
  <header class="transaction-header">
    ...
    <div class="">
      <div class="title-info">
        <div class="title-line">
          <h1><BilingualText key="receipt_form" /></h1>
	...
	<main>
  	<div class="salutation">
    	...
    	<p><BilingualText key="receipt_intro" /></p>
  	</div>
...
import {BANK_ACCOUNT_TYPE, formatMoney} from '$lib/utils.js';
