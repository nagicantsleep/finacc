{#if ( args[1] === 'forms')}
  {#if ( args[2] === 'transaction')}
    ...
    {:else if ( args[3] === 'receipt' )}
    <Receipt
      id={parseInt(args[4])}></Receipt>
    {/if}
  ...
  {:else if ( args[2] === 'financial_statement' )}
  <FinancialStatement
    term={args[3]}></FinancialStatement>
  {/if}
{/if}
<script>
...
import Receipt from './receipt/index.svelte';
