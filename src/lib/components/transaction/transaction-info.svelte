...
<script>
import {numeric, TAX_CLASS} from '$lib/utils.js';
import {DOCUMENT_KIND} from '$lib/shared/transaction-documents.js';
...
import DocumentFiles from '$lib/components/DocumentFiles.svelte';
const dispatch = createEventDispatcher();
import eventBus from '$lib/client/event-bus.js';
import {currentTransaction, getStore} from '$lib/client/current-record.js'
