...
const Receipt = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `<!-- HEAD_svelte-1t2c869_START -->${$$result.title = `<title>領収書::Hieronymus</title>`, ""}<meta http-equiv="Content-Language" content="ja"><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="stylesheet" href="/public/bootstrap-icons/font/bootstrap-icons.css"><link rel="stylesheet" href="/style/paperA4.css"><link rel="stylesheet" href="/style/transaction.css"><!-- HEAD_svelte-1t2c869_END -->`, ""} <div class="transaction"><header class="transaction-header"><div class="window-recipient-info"><p>〒${escape(transaction.zip)}</p> <p>${escape(transaction.address1)}</p> <p>${escape(transaction.address2)}</p> <p>${escape(transaction.companyName)} 御中</p></div> <div class=""><div class="title-info"><div class="title-line"><h1 data-svelte-h="svelte-1x4r7ro">領 収 書</h1> <div style="margin-left:20px;margin-top:10px;font-size:14px;"><span>No. ${escape(transaction.no)}</span></div></div> <p>発行日: 
